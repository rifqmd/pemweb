...
<body>
    ...
    <div class="container-fluid mt-03">
        <h3>List Data Jurusan <a href="insert-jurusan.php" class="btn btn-primary m-2" disabled>Input Data</a></h3>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <!-- edit jurusan -->
                                <a href="edit-jurusan.php?id=<?php echo $id; ?>" class="btn btn-success">
                                    <i class="fa-solid fa-pen"></i>
                                    Edit Data</a>
                                <!-- delete jurusan -->
                                <a href="delete_jurusan.php?id=<?php echo $id; ?>" class="btn btn-danger">
